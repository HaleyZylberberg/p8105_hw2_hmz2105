...
variable, and make education_years numeric. Specify that this is from
the MCI dataset by adding a column called MCI.
...
MCI.And then redo data description. Also change age at onset to a
numeric value.
...
65.7425532 and age at onset is 70.3553191. There are 50 females. There
are 28 participants with at least 1 missing time value.
